...
public class ArcTeleporter : MonoBehaviour {
    ...
    OVRInput.Controller TouchController
    {
        get
        {
            OVRInput.Controller touchControllers = OVRInput.GetConnectedControllers();
            if ((touchControllers & OVRInput.Controller.LTouch) == OVRInput.Controller.LTouch)
            {
                return OVRInput.Controller.LTouch;
            }
            if ((touchControllers & OVRInput.Controller.RTouch) == OVRInput.Controller.RTouch)
            {
    ...
    private bool HasTouchController
    {
        get
        {
            OVRInput.Controller touchControllers = OVRInput.GetConnectedControllers();
	...
	Matrix4x4 ControllerToWorldMatrix {
		get {
			...
			Quaternion orientation = OVRInput.GetLocalControllerRotation(TouchController);
			Vector3 position = OVRInput.GetLocalControllerPosition (TouchController);
